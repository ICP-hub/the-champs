      ...
      <div className="flex justify-between ">
        ...
        <div className=" lg:w-[12%]  ">
          <Menu as="div" className="relative inline-block text-left w-full">
            ...
            >
              <Menu.Items className="absolute right-0 mt-2 w-[350px] origin-top-right divide-y  divide-gray-100 rounded-xl bg-white shadow-lg ring-1 ring-black/5 focus:outline-none">
                <div className="px-1 py-1 ">
                  <div className="m-6 text-center">
                    <h1 className="text-md  text-left font-medium">
                      Floor Price
                    </h1>
                    <button className="mt-5  flex items-center w-full justify-center text-gray-500 px-3 py-2 border-[1.5px] border-gray-300  hover:bg-violet-500 hover:text-white rounded-md">
                      Highest to Lowest
                    </button>
                    <button className="mt-4  flex items-center w-full justify-center text-gray-500 px-3 py-2 border-[1.5px] border-gray-300  hover:bg-violet-500  hover:text-white rounded-md">
                      Lowest to Highest
                    </button>
                  </div>
                  <div className="m-6 text-center">
                  ...
                  <div className="m-6 text-center">
                    <button
                      className="mt-8  flex items-center w-full justify-center  px-3 py-2 border-[1.5px] border-gray-300 bg-[#6D01F6] text-white rounded-md"

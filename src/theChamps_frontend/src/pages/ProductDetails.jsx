          ...
          <div className=" gap-8 md:w-3/4  ">
            ...
            <div className="mt-8">
              ...
              <p className="text-sm mt-4">
                ...
                Voluptates exercitationem, aperiam et abcde cupiditate
                consectetur accusantium illo harum id magni quaerat ea
                asperiores amet, optio labore illum repellendus odio
                necessitatibus sed?
              </p>
            </div>
          </div>

      ...
      <div className="md:flex gap-8">
        ...
        <div className=" gap-8 md:w-2/3  ">
          <div className="flex items-center gap-4">
            <IoArrowBack />
            <p className="text-xl font-medium">Back to Collections</p>
          </div>
          ...
          <div className="mt-8">
            ...
            <p className="text-sm mt-4">
              ...
              Voluptates exercitationem, aperiam et abcde cupiditate consectetur
              accusantium illo harum id magni quaerat ea asperiores amet, optio
              labore illum repellendus odio necessitatibus sed?
            </p>
          </div>
        </div>
      </div>

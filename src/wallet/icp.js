...
import { idlFactory } from './theChamps_frontend.did.js';
export { idlFactory } from './theChamps_frontend.did.js';
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./theChamps_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the theChamps_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./theChamps_frontend.did.js")._SERVICE>}
 */
export const theChamps_frontend = createActor(canisterId);
